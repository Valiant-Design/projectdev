    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="www.linkedin.com/in/adebari-uthman-titilope-57160a227" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://www.github.com/" aria-label="GitHub" data-social="github">
            <div className="filled" />
            <svg xmlns="https://github.com/Valiant-Design" width={16} height={16} fill="currentColor" className="bi bi-github" viewBox="0 0 16 16" xmlSpace="preserve">
